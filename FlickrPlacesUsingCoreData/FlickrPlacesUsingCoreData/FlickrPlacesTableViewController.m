...
- (void)viewDidLoad
{
    ...
    self.navigationItem.titleView = [AppDelegate getTitleLabelwithTitle:@"Top Rated"];
...
{  
    ...
    PhotoSegmentedViewController* photoSVC = [[PhotoSegmentedViewController alloc] init];
    photoSVC.photoPlace = [self placeAtIndexPath:indexPath];
    photoSVC.view.frame = self.view.frame;
    ...
    NSDictionary* thisPlace = [self placeAtIndexPath:indexPath];
    // Get the City object for this row
    photoTVC.city = [City cityWithFlickrData:thisPlace inManagedObjectContext:[(AppDelegate*)[[UIApplication sharedApplication] delegate]  managedObjectContext]];
...
/*
    ...
    PhotoCollectionViewController * photoCVC = [[PhotoCollectionViewController alloc] initWithCollectionViewLayout:flowLayout];
    
        NSDictionary* thisPlace = [self placeAtIndexPath:indexPath];
    photoCVC.title = [thisPlace valueForKey:@"woe_name"];
